      ...
      <div className='relative z-10'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 justify-center'>
          ...
          <div  className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] lg:w-[222px] lg:h-[365px] relative shadow-2xl bg-red-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Fun City</h2>
              <p className='text-white '>Get ready for a thrilling adventure with Fun City Bounce, where imagination knows no bounds and excitement bounces to new heights!</p>
            </div>
          </div>
          ...
          <div  className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-yellow-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Cimbing Wall</h2>
              <p className='text-white'>There's a bouncy climbing wall that's ready for anyone to try, no matter how big or small they are...</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-green-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Bouncing Slide</h2>
              <p className='text-white'>Imagine stepping into a magical world where you can defy gravity and bounce like never before. Get ready to explore the amazing world of bouncing slides!</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-blue-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Bouncing Castle</h2>
              <p className='text-white'>Imagine a place where you can jump, bounce, and let your energy run wild. It's time to enter the magical realm of the bouncing castle!</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-indigo-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Trampoline</h2>
              <p className='text-white'>Imagine a magical surface that lets you bounce higher than you ever thought possible it's time to discover the incredible world of the trampoline!</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-purple-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Train Ride</h2>
              <p className='text-white'>Get ready to embark on a train adventure that's as enchanting as a journey through storybook lands!</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-orange-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Costumes</h2>
              <p className='text-white'>Have you ever seen magical outfits that can transport you to different fairy tales just by seeing them on!</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-pink-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Decorations</h2>
              <p className='text-white'>Are you ready to make your special occasions shine brighter than ever? We would show you our incredible party decorations that will turn your celebrations into unforgettable moments of joy and magic...</p>
            </div>
          </div>
          ...
          <div className='p-6 w-[222px] h-[365px] sm:w-[222px] sm:h-[365px] md:w-[222px] md:h-[365px] relative shadow-2xl bg-violet-300 rounded-xl'>
            ...
            <div className='mt-4'>
              <h2 className='text-xl font-semibold mb-2 text-center'>Other Fun Stuff</h2>
              <p className='text-white'> Get set for the most incredible adventure with "Fun Stuff"! Picture a world where excitement never ends, where you can dive into a sea of laughter, games, and amazing activities!</p>
            </div>
          </div>
