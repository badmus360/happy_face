       ...
       <div className='w-full bg-gradient-to-r from-green-200 to-purple-200 min-h-screen px-10 sm:px-10 pb-10 sm:pb-10 lg:pb-10 md:pb-10 lg:px-10 md:px-10 flex flex-col items-center justify-center relative '>   
          <div className='text-center text-[46px] sm:text-[65px] mb-4 font-bold mt-6 xl:mb-6 xl:mt-8 lg:text-[50px] xl:text-[70px]'><span className='text-red-500'>Who we are</span> <span className='text-yellow-500'>and</span> <span className='text-green-500'>what we do</span><span className='text-purple-500'>...</span></div>
              <div className='grid gap-10 sm:grid md:grid lg:grid justify-center group'>
                 ...
                 <div className='bg-black sm:gap-2 w-[400px] h-[690px] gap-1 sm:w-[600px] sm:h-[900px] md:w-[700px] md:h-[290px] lg:w-[915px] lg:h-[400px] xl:w-[1150px] xl:h-[500px] grid sm:grid md:grid-cols-2 bg-opacity-30 b-5 p-2 sm:p-4 md:p-6 lg:p-6 xl:p-8 rounded-lg shadow-md'>
                      <aside class="bg-green-300 h-[300px] sm:h-[470px] mt-0 sm:mt-0 md:mt-0 md:mr-4 rounded-lg p-2">
                              <span className='text-[30px] text-red-600 font-bold sm:text-[50px] lg:text-[38px] xl:text-[45px]'>...we are party shakers</span>
                              <p className='text-[22px] font-semibold sm:text-[36px] lg:text-3xl xl:text-4xl'>we've got a secret ingredient to make your parties shake with excitement! Imagine us as the musical magicians who bring the beats and rhythms that make your feet tap, your hips sway, and your heart dance. We're the ones with the coolest DJ music that's like a sprinkle of magic dust over your party</p>
                      </aside>

                      <SlideShow images={slides.slides2} />
                  </div>
                  
                  <div className='bg-black sm:gap-2 w-[400px] h-[690px] sm:w-[600px] sm:h-[900px] md:w-[700px] md:h-[290px] lg:w-[915px] lg:h-[400px] xl:w-[1150px] xl:h-[500px] grid sm:grid md:grid-cols-2 bg-opacity-30 p-2 sm:p-4 md:p-6 lg:p-6 xl:p-8 rounded-lg shadow-md'>

                      <SlideShow images={slides.slides3} />
                      <aside class="bg-yellow-300 h-[300px] sm:h-[470px] mt-1 sm:mt-0 md:mt-0 md:ml-4 rounded-lg p-2">
                              <span className='text-[30px] text-red-600 font-bold sm:text-[50px] lg:text-[38px] xl:text-[45px]'>...we create</span>
                              <p className='text-[22px] font-semibold sm:text-[36px] lg:text-3xl xl:text-4xl'>We're not just ordinary creators; we're the wizards behind the scenes, crafting enchanting items that capture the spirit of the amusement park. From whimsical artwork that captures the joy of the carousel to cozy blankets that make you feel like you're on the Ferris wheel, we pour our heart and soul into every creation.</p>
                      </aside>
                  </div>
  
                  <div className='bg-black sm:gap-2 w-[400px] h-[690px] gap-1 sm:w-[600px] sm:h-[900px] md:w-[700px] md:h-[290px] lg:w-[915px] lg:h-[400px] xl:w-[1150px] xl:h-[500px] grid sm:grid md:grid-cols-2 bg-opacity-30 p-2 sm:p-4 md:p-6 lg:p-6 xl:p-8 rounded-lg shadow-md'>
                      <aside class="bg-pink-300 h-[300px] sm:h-[470px] sm:mt-0 md:mt-0 md:mr-4 rounded-lg p-2">
                              <span className='text-[30px] text-red-600 font-bold sm:text-[50px] lg:text-[38px] xl:text-[45px]'>...we sell</span>
                              <p className='text-[22px] font-semibold sm:text-[36px] lg:text-3xl xl:text-4xl'>Are you ready to take a piece of an amusement park magic? "bringing the thrill of the amusement park right to you Imagine this: you're riding the happiest roller coasters, playing the most exciting games. Now, what if we told you that you can keep that excitement alive even after you've left the park.</p>
                      </aside>
                  ...
                  <div className='bg-black sm:gap-2 w-[400px] h-[690px] sm:w-[600px] sm:h-[900px] md:w-[700px] md:h-[290px] lg:w-[915px] lg:h-[400px] xl:w-[1150px] xl:h-[500px] grid sm:grid md:grid-cols-2 bg-opacity-30 p-2 sm:p-4 md:p-6 lg:p-6 xl:p-8 rounded-lg shadow-md'>
                      ...
                      <aside class="bg-cyan-300 h-[300px] sm:h-[470px] mt-1 sm:mt-0 md:mt-0 md:ml-4 rounded-lg p-2">
                              <span className='text-[30px] text-red-600 font-bold sm:text-[50px] lg:text-[38px] xl:text-[45px]'>...we rent</span>
                              <p className='text-[22px] font-semibold sm:text-[36px] lg:text-3xl xl:text-4xl'>Imagine this: the thrill of riding a roller coaster, the joy of playing games, and the wonder of exploring new worlds. Now, what if we told you that you can have all that excitement and more, anytime you want? That's exactly what "FunWorld Creations" is here for – to fill your days with play, and endless amusement!</p>
                      </aside>
                  </div> 
